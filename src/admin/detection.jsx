...
const Detection = () => {
  ...
  return (
    <div className="flex pt-8 justify-center items-center min-h-screen bg-gray-900">
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-lg">
        <h2 className="text-2xl font-semibold text-white text-center mb-6">MRI Analysis</h2>
        ...
        <div className="mb-4">
          <label className="bg-blue-600 hover:bg-blue-500 px-4 py-2 rounded-lg cursor-pointer flex items-center gap-2 text-white">
        ...
        {imagePreview && (
          <div className="flex justify-center mb-4">
            <img src={imagePreview} alt="Uploaded X-ray" className="w-64 h-auto rounded-lg border-2 border-cyan-500 shadow-lg" />
          </div>
        )}
        ...
        <button
          onClick={analyzeXray}
          disabled={loading}
          className="w-full bg-green-600 hover:bg-green-500 px-4 py-2 rounded-lg text-white mb-4 flex items-center justify-center gap-2"
        >
